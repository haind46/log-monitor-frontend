...
export default function UserHeading() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess(data : any) {
      ...
      toast({     
        title: t("department.form.success"),
      });
  ...
  function deleteDepartments() {
    confirm({
      title:  t("department.form.mutipleDelete"),
      description: `(${selectedUserIds.length}) `+ t("department.form.mutipleDeleteTitle"),
      async onOk() {
    ...
    <div className="w-full flex justify-between mb-4">
      ...
      <div className="flex items-center">
        {selectedUserIds.length > 0 && (
          <Button variant="destructive" onClick={deleteDepartments}>
